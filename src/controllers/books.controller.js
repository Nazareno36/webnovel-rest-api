...
const booksCtrl = {
  getBooks: async (req, res) => {
    try {
      ...
      const foundBooks = novelId
        ? await Book.find({ ...req.query, novelId: novelId })
  ...
  getBookById: async (req, res) => {
    try {
      ...
      const foundBook = novelId
        ? await Book.findOne({ _id: bookId, novelId: novelId })
